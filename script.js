...
const API_KEY = '8d03f4ad696107fd6eea2adf5789177e';
...
setInterval(() => {
    ...
    const hoursIn2HrFormat = hour >= 13 ? hour %12 : hour;
    const minutes = time.getMinutes();
    const ampm = hour >=12 ? 'PM' : 'AM';

    timeEl.innerHTML = (hoursIn2HrFormat < 10 ? '0' + hoursIn2HrFormat : hoursIn2HrFormat) + ':' + (minutes <10? '0' + minutes: minutes) + ' ' + `<span id="am-pm">${ampm}</span>`
